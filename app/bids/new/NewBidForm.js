    ...
    <div className="lg:flex lg:gap-8 max-w-4xl">
      <div className="flex-1 min-w-0 space-y-5">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          <Field label="Bid rate ($/lb)" hint="blank = recommended"><input type="number" step="0.0001" className="inp inp-need" value={form.bidRate} onChange={(e) => set("bidRate", e.target.value)} placeholder="auto" /></Field>
