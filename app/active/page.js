// Active Projects — server component: fetch through the data layer, render the client table.
...
export default async function ActiveWorkPage() {
  ...
  return (
    <AppShell current="active" breadcrumbs={[{ label: "Active Projects" }]} title="Active Projects"
