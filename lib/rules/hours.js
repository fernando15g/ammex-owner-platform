...
export function summarizeTimesheet(cards) {
  ...
  return { perProject, unassigned, underReviewTotal, voidedTotal, realizedHoursPerDay };
}
...
export function actualHoursForProject(summaryEntry, payrollHours) {
  ...
  return {
    era: "payroll",
    hours: typeof payrollHours === "number" ? payrollHours : null,
