...
const PROJECT_EDITABLE = ["name", "projectId", "status", "actualStartDate", "foreman", "relatedBidId", "relatedBidIds", "gc", "phaseLabels", "payrollHours", "manualHoursOverride", "placedLbs", "siteStreet", "siteCity", "siteState", "siteZip", "siteLat", "siteLng"];
