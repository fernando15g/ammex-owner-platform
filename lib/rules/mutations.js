...
const PROJECT_EDITABLE = ["name", "projectId", "status", "actualStartDate", "foreman", "relatedBidId", "relatedBidIds", "gc", "phaseLabels", "payrollHours", "manualHoursOverride", "placedLbs", "siteStreet", "siteCrossroads", "siteCity", "siteState", "siteZip", "siteLat", "siteLng", "sitePinManual", "notes", "hoursMode", "billingJobReference", "supplierPoNotified"];
