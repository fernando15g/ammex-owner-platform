...
export async function getHome() {
  const [pipeline, active, billing, book, perf, timesheet] = await Promise.all([
    getPipeline(), getActiveWork(), getBillingOverview(), getBook(), getPerformance(), getTimesheetPulse(),
  ]);
