...
export async function getCapacity() {
  ...
  // pace = hours actually logged in the window (that IS the burn). If we're
  // burning X hrs/week and have Y hrs of won work left, it lasts Y/X weeks.
  ...
  return {
    ...
    committed: {
      ...
      backlogHours: committed.remainingHours - committed.runningRemainingHours,
      runwayWeeks,
    },
