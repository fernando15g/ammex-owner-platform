...
import { queryAll, bustNotionReadCache, bustNotionReadCacheFor, probeDatabase, getTitle, getText, getNumber, getDate, getStatus, getSelect, getCheckbox, getMultiSelect, getRelationIds, getRollupNumber, lastEdited, pageId } from "@/lib/notion/client";
...
export async function getPipeline() {
  ...
  bustNotionReadCacheFor(DB.BID_TRACKER);
  const data = await getEverything();
